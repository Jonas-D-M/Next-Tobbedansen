            ...
            <div className='o-layout__item u-1-of-2-bp3'>
              ...
              <div className='c-lead c-lead--text u-mb-lg'>
                <p>
                  ...
                  stalen ros en parkeer je fiets aan de aanliggende wegen of in
                  het dorpscentrum.
                </p>
              </div>
              <h2>Met de wagen?</h2>
              <div className='c-lead c-lead--text u-mb-lg'>
                <p>
                  Kom je (al dan niet carpoolend) met de wagen? Hou dan rekening
                  dat er geen parking voorzien is. Parkeren kan op “parking
                  leihoekstraat” of in de kloosterstraat. Indien je bent
                  genoodzaakt om te parkeren langs straat, hou dan zeker
              ...
              <div className='c-lead c-lead--text u-mb-lg'>
                <ul>
                  <li>
                    <p>
                      Op vrijdag 1 september openen de deuren om 19u en sluiten
                      we de eerste avond af om 2u.
                    </p>
                  </li>
                  <li>
                    <p>
              ...
              <div className='c-lead c-lead--text u-mb-lg'>
                <p>
                  ...
                  lijkt onmogelijk maar het kan. Neem dan contact op met ons en
                  we proberen jouw vraag zo snel mogelijk te beantwoorden. Je
                  bereikt ons via het contactformulier.
                </p>
              </div>
            </div>
          </div>
