          ...
          <div className='o-layout'>
            ...
            <div className='o-layout__item u-1-of-2-bp3'>
              <p className='c-lead c-lead--text u-mb-lg'>
                Iedereen die vorig jaar aanwezig was, kan getuigen. Tobbedansen
                2022 was een editie om nooit te vergeten. Zowel
              ...
              <p className='c-lead c-lead--text u-mb-lg'>
                ...
                <i>Go ninja GO</i>, bekend van onder meer Vlaanderen Feest, het
                feestje compleet zullen maken. Wanneer iedereen volledig is
                opgewarmd zal <i>Nine 2 Five</i> met enkele vette beats en Viool
                de ambiance naar een hoogtepunt brengen. Tot slot zal
                <i>TWO FOR YOU</i>
                driedubbele knopen in de veters van ieders dansschoenen draaien
                tot het einde van de avond!
              </p>
              <p className='c-lead c-lead--text u-mb-lg'>
                Net zoals vorig jaar zijn er zowel combi-tickets als aparte
                tickets te koop. Voor een ticket voor zowel vrijdag als zaterdag
                betaal je 10 euro, voor enkel vrijdag betaal je 6 euro. Tickets
                zijn aan de kassa te verkrijgen.
              </p>
