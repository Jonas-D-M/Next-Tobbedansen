 ...
 */
import { customClientInstance } from '../mutators/tickets-client';
...
export const getEventTickets = async (
  ...
  return customClientInstance<Ticket[]>(getGetEventTicketsUrl(eventId), {
    ...options,
    method: 'GET',
  });
};
...
export const purchaseTickets = async (
  ...
  return customClientInstance<PurchaseResponse>(
    getPurchaseTicketsUrl(eventId),
    {
      ...options,
      method: 'POST',
    }
